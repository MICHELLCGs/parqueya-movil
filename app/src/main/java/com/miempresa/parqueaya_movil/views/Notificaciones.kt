...
@Composable
fun Noticontenido(navController: NavController){
    ...
    Column(
        ...
        Box(
            ...
            Text(text = "Buzón de avisos", color = Color(0xFFFFFFFF),
                fontSize = 40.sp,
            ...
            Box(
                ...
                Row(){
                    Text(text="Nuevos", color=Color(0xFF15196C), fontSize = 15.sp, fontWeight = FontWeight.Bold,
                        modifier=Modifier
